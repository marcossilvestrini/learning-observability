...
このプロジェクトは、Learning Observability について学ぶためのプロジェクトです。
...
プロジェクトリンク:[ｈっｔｐｓ：／／ぎてゅｂ。こｍ／まｒこっしｌゔぇｓｔりに／ぇあｒにんｇーおｂせｒゔぁびぃｔｙ](https://github.com/marcossilvestrini/learning-observability)
